...
import com.example.config.RandomValidateCodeConfig;
...
public class PicVerifyAction {
    ...
    public void getVerify(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            RandomValidateCodeConfig randomValidateCode = new RandomValidateCodeConfig();
    ...
    public boolean checkVerify(@RequestBody String verifyInput, HttpSession session) {
        try {
